...
class PartnerApi
{
     ...
     * Create a partner
     *
     * @param  \Billingo\Model\PartnersBody $body PartnerUpsert object that you would like to store. (required)
     *
     ...
     * Update a partner
     *
     * @param  \Billingo\Model\PartnersIdBody $body Partner object that you would like to update. (required)
     * @param  int $id id (required)
     *
     * @throws \Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
