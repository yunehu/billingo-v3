...
$apiInstance = new Billingo\Api\SpendingApi(
...
# **spendingList**
> \Billingo\Model\SpendingList spendingList($page, $per_page)
...
[**\Billingo\Model\SpendingList**](../Model/SpendingList.md)
...
# **spendingSave**
> \Billingo\Model\Spending spendingSave($body)
...
$body = new \Billingo\Model\SpendingSave(); // \Billingo\Model\SpendingSave | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Billingo\Model\SpendingSave**](../Model/SpendingSave.md)|  | [optional]

### Return type

[**\Billingo\Model\Spending**](../Model/Spending.md)
...
# **spendingShow**
> \Billingo\Model\Spending spendingShow($id)
...
# **spendingUpdate**
> \Billingo\Model\Spending spendingUpdate($id, $body)
