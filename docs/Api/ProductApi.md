...
# **createProduct**
> \Billingo\Model\Product createProduct($body)
...
$apiInstance = new Billingo\Api\ProductApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \Billingo\Model\Product(); // \Billingo\Model\Product | Product object that you would like to store.
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Billingo\Model\Product**](../Model/Product.md)| Product object that you would like to store. |

### Return type

[**\Billingo\Model\Product**](../Model/Product.md)
...
# **getProduct**
> \Billingo\Model\Product getProduct($id)
...
# **listProduct**
> \Billingo\Model\ProductList listProduct($page, $per_page, $query)
...
[**\Billingo\Model\ProductList**](../Model/ProductList.md)
...
# **updateProduct**
> \Billingo\Model\Product updateProduct($body, $id)
...
$body = new \Billingo\Model\Product(); // \Billingo\Model\Product | Product object that you would like to update.
$id = 56; // int | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Billingo\Model\Product**](../Model/Product.md)| Product object that you would like to update. |
 **id** | **int**|  |
