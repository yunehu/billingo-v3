...
# **createPartner**
> \Billingo\Model\Partner createPartner($body)
...
$apiInstance = new Billingo\Api\PartnerApi(
...
[**\Billingo\Model\Partner**](../Model/Partner.md)
...
# **getPartner**
> \Billingo\Model\Partner getPartner($id)
...
# **listPartner**
> \Billingo\Model\PartnerList listPartner($page, $per_page, $query)
...
[**\Billingo\Model\PartnerList**](../Model/PartnerList.md)
...
# **updatePartner**
> \Billingo\Model\Partner updatePartner($body, $id)
